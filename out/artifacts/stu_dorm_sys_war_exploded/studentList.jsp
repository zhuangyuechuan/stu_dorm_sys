...
<%@taglib prefix="Pager" uri="page-tag" %> 
...
<div class="data_list">
		...
		<div style="text-align: center;font-size:12px;">
			<!--totalNum:查询出的总数据量     pageSize：每一页展示的行数    pageIndex:表示当前页面  
				submitUrl：表示点击上一页下一页首页尾页是发送的请求-->
			<Pager:pager 
				totalNum ="${totalNum}"
				pageSize ="3"
				pageIndex="${pageIndex}"
				submitUrl="${pageContext.request.contextPath}/student.action?action=list&searchType=${searchType}&keyword=${keyword}&dormBuildId=${dormBuildId}">
			</Pager:pager>
		</div>
